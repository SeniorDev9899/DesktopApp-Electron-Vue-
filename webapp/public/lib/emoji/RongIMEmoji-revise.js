...
(function(global, factory) {
    ...
    var emojiFactory = {
        ...
        // 暂时直接处理, Emoji 插件扩展不能设置顺序, 往后加入顺序设置
        'u1F91D': { 'en': 'Handshake', 'zh': '握手', 'tag': '🤝', 'position': '0 0', 'background': './lib/emoji/handshake.png' },
    ...
    var configs = {
        url: isIE8 ? normalImagePath : hdImagePath,
        size: 24,
        lang: 'zh',
        reg: unicodeRegExp
    };
    ...
    var getEmojiShadowDom = function (object) {
        var fontstyle = 'width: {{size}}px; height: {{size}}px; line-height: {{size}}px; overflow: hidden; vertical-align: middle; font-size: 0 !important;';
        var imagestyle = 'width: {{size}}px; height: {{size}}px;';
        var spanTpl = '<span style=\'{{fontstyle}}\'>{{tag}}<img style=\'{{imagestyle}}\' src="{{background}}" class=\'rong-emoji-content\' name=\'[{{name}}]\' /></span>';
        spanTpl = spanTpl.replace(/{{fontstyle}}/g, fontstyle);
        spanTpl = spanTpl.replace(/{{imagestyle}}/g, imagestyle);
